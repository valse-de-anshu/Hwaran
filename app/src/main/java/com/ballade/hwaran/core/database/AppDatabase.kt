package com.ballade.hwaran.core.database
...
import com.ballade.hwaran.core.database.dao.AnnotationDao
import com.ballade.hwaran.core.database.dao.HistoryDao
import com.ballade.hwaran.core.database.dao.MediaDao
import com.ballade.hwaran.core.database.dao.TrackDao
...
@Database(entities = [MangaEntity::class, ChapterEntity::class, HistoryEventEntity::class, PdfMarkerEntity::class], version = 16, exportSchema = false)
